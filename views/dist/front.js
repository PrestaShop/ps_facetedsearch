 ...
 * @license   https://opensource.org/licenses/AFL-3.0 Academic Free License 3.0 (AFL-3.0)
 * International Registered Trademark & Property of PrestaShop SA
 */const a="symbol";var c=class extends s{constructor(t,e,i,n,o,s,a,c,l,u){if(super(t,e,i,n,o,s,a,c),this.currencySymbol=l,this.currencyCode=u,!this.currencySymbol||"string"!=typeof this.currencySymbol)throw new r("Invalid currencySymbol");if(!this.currencyCode||"string"!=typeof this.currencyCode)throw new r("Invalid currencyCode")}static getCurrencyDisplay(){return a}getCurrencySymbol(){return this.currencySymbol}getCurrencyCode(){return this.currencyCode}};
/**
 * 2007-2019 PrestaShop.
 *
 * NOTICE OF LICENSE
 ...
 * @license   https://opensource.org/licenses/AFL-3.0 Academic Free License 3.0 (AFL-3.0)
 * International Registered Trademark & Property of PrestaShop SA
 */const l="¤",u=".",p=",",f="-",d="%",h="+";class g{constructor(t){this.numberSpecification=t}format(t,e){void 0!==e&&(this.numberSpecification=e);const i=Math.abs(t).toFixed(this.numberSpecification.getMaxFractionDigits());let[n,r]=this.extractMajorMinorDigits(i),o=n=this.splitMajorGroups(n);(r=this.adjustMinorDigitsZeroes(r))&&(o+=u+r);const s=this.getCldrPattern(n<0);return o=this.addPlaceholders(o,s),o=this.replaceSymbols(o),o=this.performSpecificReplacements(o)}extractMajorMinorDigits(t){const e=t.toString().split(".");return[e[0],void 0===e[1]?"":e[1]]}splitMajorGroups(t){if(!this.numberSpecification.isGroupingUsed())return t;const e=t.split("").reverse();let i=[];for(i.push(e.splice(0,this.numberSpecification.getPrimaryGroupSize()));e.length;)i.push(e.splice(0,this.numberSpecification.getSecondaryGroupSize()));i=i.reverse();const n=[];return i.forEach(t=>{n.push(t.reverse().join(""))}),n.join(p)}adjustMinorDigitsZeroes(t){let e=t;return e.length>this.numberSpecification.getMaxFractionDigits()&&(e=e.replace(/0+$/,"")),e.length<this.numberSpecification.getMinFractionDigits()&&(e=e.padEnd(this.numberSpecification.getMinFractionDigits(),"0")),e}getCldrPattern(t){return t?this.numberSpecification.getNegativePattern():this.numberSpecification.getPositivePattern()}replaceSymbols(t){const e=this.numberSpecification.getSymbol();let i=t;return i=(i=(i=(i=(i=i.split(u).join(e.getDecimal())).split(p).join(e.getGroup())).split(f).join(e.getMinusSign())).split(d).join(e.getPercentSign())).split(h).join(e.getPlusSign())}addPlaceholders(t,e){return e.replace(/#?(,#+)*0(\.[0#]+)*/,t)}performSpecificReplacements(t){return this.numberSpecification instanceof c?t.split(l).join(this.numberSpecification.getCurrencySymbol()):t}static build(t){const e=new o(...t.symbol);let i;return i=t.currencySymbol?new c(t.positivePattern,t.negativePattern,e,parseInt(t.maxFractionDigits,10),parseInt(t.minFractionDigits,10),t.groupingUsed,t.primaryGroupSize,t.secondaryGroupSize,t.currencySymbol,t.currencyCode):new s(t.positivePattern,t.negativePattern,e,parseInt(t.maxFractionDigits,10),parseInt(t.minFractionDigits,10),t.groupingUsed,t.primaryGroupSize,t.secondaryGroupSize),new g(i)}}var m=g;
/**
 * 2007-2019 PrestaShop.
 *
 * NOTICE OF LICENSE
