 ...
 * @license   https://opensource.org/licenses/AFL-3.0 Academic Free License 3.0 (AFL-3.0)
 * International Registered Trademark & Property of PrestaShop SA
 */let g;const v=(t,e,i)=>{void 0===g?t.text(t.text().replace(/([^\d]*)(?:[\d .,]+)([^\d]+)(?:[\d .,]+)(.*)/,`$1${e}$2${i}$3`)):t.text(`${g.format(e)} - ${g.format(i)}`)};var m=()=>{$(".faceted-slider").each(function(){const t=$(this),e=t.data("slider-values"),i=t.data("slider-specifications");i.length&&(g=h.build(i)),v($(`#facet_label_${t.data("slider-id")}`),null===e?t.data("slider-min"):e[0],null===e?t.data("slider-max"):e[1]),$(`#slider-range_${t.data("slider-id")}`).slider({range:!0,min:t.data("slider-min"),max:t.data("slider-max"),values:[null===e?t.data("slider-min"):e[0],null===e?t.data("slider-max"):e[1]],change(e,i){const n=t.data("slider-encoded-url"),r=t.data("slider-encoded-facets").replace(/%20/g,"+"),s=new RegExp(`${(t=>t.replace(/[-[\]{}()*+!<=:?.\/\\^$|#\s,]/g,"\\$&"))(t.data("slider-unit"))}-\\d+-\\d+`),o=`${t.data("slider-unit")}-${i.values[0]}-${i.values[1]}`;prestashop.emit("updateFacets",n.replace(encodeURIComponent(r),r.replace(s,o)))},slide(e,i){v($(`#facet_label_${t.data("slider-id")}`),i.values[0],i.values[1])}})})};i(2);
/**
 * 2007-2019 PrestaShop.
 *
 * NOTICE OF LICENSE
 ...
 * International Registered Trademark & Property of PrestaShop SA
 */
$(document).ready(()=>{prestashop.on("updateProductList",()=>{$(".faceted-overlay").remove(),m()}),m(),prestashop.on("updateFacets",()=>{1!==$(".faceted-overlay").length&&$("body").append(y)})});i(4),i(6)}]);
