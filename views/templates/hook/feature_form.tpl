...
<div class="form-group">
	...
	<div class="col-lg-9">
		<div class="row">
			...
			{/foreach}
			<div class="col-lg-9">
				<p class="help-block">{l s='When the Layered Navigation Block module is enabled, you can get more detailed URLs by choosing the word that best represent this feature. By default, PrestaShop uses the feature\'s name, but you can change that setting using this field.' mod='ps_facetedsearch'}</p>
			</div>
		</div>
	</div>
</div>
<div class="form-group">
	...
	<div class="col-lg-9">
		<div class="row">
			...
			{/foreach}
			<div class="col-lg-9">
				<p class="help-block">{l s='When the Layered Navigation Block module is enabled, you can get more detailed page titles by choosing the word that best represent this feature. By default, PrestaShop uses the feature\'s name, but you can change that setting using this field.' mod='ps_facetedsearch'}</p>
			</div>
		</div>
	</div>
</div>
