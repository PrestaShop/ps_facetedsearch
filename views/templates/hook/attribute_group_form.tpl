...
<div class="form-group">
	<label class="control-label col-lg-3" for="">{l s='Indexable' mod='ps_facetedsearch'}</label>
	<div class="col-lg-9">
	...
	<div class="col-lg-9 col-lg-push-3">
		<p class="help-block">{l s='Use this attribute in URL generated by the layered navigation module.' mod='ps_facetedsearch'}</p>
	</div>
</div>
