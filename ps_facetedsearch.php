...
class Ps_Facetedsearch extends Module implements WidgetInterface
{
    ...
    public function install()
    {
        ...
        if ($this->uninstallPrestaShop16Module()) {
            // ToDo: Does `layered_category` stores critical data?
            $this->rebuildLayeredStructure();

            // ToDo: Does `layered_price_index` stores critical data ? Probably not with `_index`
            ...
            // ToDo: What cache do we need to (re)generate ?
        } else {
